...
import { useBrokerHeldentrader, useBrokerInteractiveBrokers, useBrokerMetaTrader5, useBrokerTdAmeritrade, useBrokerTradeStation, useBrokerTradeZero, useBrokerWebull, useTradovate, useNinjaTrader, useRithmic, useFundTraders, useTastyTrade, useTopstepX } from './brokers.js'
...
export async function useImportTrades(param1, param2, param3, param0) {
    return new Promise(async (resolve, reject) => {
        ...
        let readAsTextArray = ["tradeZero", "template", "tdAmeritrade", "interactiveBrokers" , "tradovate", "ninjaTrader", "heldentrader", "rithmic", "fundTraders", "tastyTrade", "topstepX", "webull"]
        ...
        ****************************/
        ...
        if (selectedBroker.value == "webull") {
            console.log(" -> Webull")
            await useBrokerWebull(fileInput).catch(error => {
                importFileErrorFunction(error)
            })
        }
